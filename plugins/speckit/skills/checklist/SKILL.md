...
name: checklist
description: >
  Generate a domain-specific quality checklist for requirements validation.
  Use when the user asks to "create checklist", "quality checklist",
  "создай чеклист", or needs to validate spec completeness.
---
