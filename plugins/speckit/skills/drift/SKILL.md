...
name: drift
description: >
  Analyze drift between specifications and implementation to find divergence.
  Use when the user asks to "analyze drift", "spec drift", "дрифт спеки",
  or wants to compare requirements against actual code.
---
