...
name: forge
description: >
  Full lifecycle orchestrator for Product Forge v1.5.0. Drives a feature from idea
  to shipped code across lite/standard/v-model modes with approval gates and
  sync-verify. Use: "forge feature", "run full cycle",
