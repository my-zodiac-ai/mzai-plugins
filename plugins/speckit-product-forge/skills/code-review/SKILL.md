...
name: code-review
description: >
  Phase 6B: Multi-agent code review after implementation covering code quality,
  security (OWASP), pattern consistency, and test coverage. Use: "forge code
  review", "/speckit.product-forge.code-review"
---
