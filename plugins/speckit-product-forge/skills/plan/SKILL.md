...
name: plan
description: >
  Phase 5: Generate technical plan from spec.md with cross-validation against
  product-spec. Ensures plan covers all Must Have user stories. Use: "forge plan",
  "create plan", "/speckit.product-forge.plan"
---
