...
name: product-spec
description: >
  Phase 2: Interactive product specification with configurable detail level
  (lite/standard/full) and automatic decomposition of large features. Use:
  "product spec", "write product spec", "/speckit.product-forge.product-spec"
---
