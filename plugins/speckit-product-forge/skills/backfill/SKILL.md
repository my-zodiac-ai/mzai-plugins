...
name: backfill
description: >
  Brown-field entry: reverse-engineer a Product Forge feature folder from existing
  code. Produces retro product-spec, plan, tasks, and gaps-report. Use: "backfill
  module", "/speckit.product-forge.backfill"
---
