...
name: tasks
description: >
  Phase 5B: Generate task breakdown from plan.md with cross-validation against
  product-spec. Produces tasks.md ready for implement. Use: "forge tasks",
  "generate tasks", "/speckit.product-forge.tasks"
---
