...
description: >
  Phase 0: Validate the problem before research. JTBD analysis, interview script,
  Problem Statement Canvas, Go/No-Go decision. Use: "discover problem", "problem
  discovery", "/speckit.product-forge.problem-discovery"
---
